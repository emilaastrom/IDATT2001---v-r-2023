...
public class PathsView {
  ...
  public void showStats(){
    ...
    if (Game.getInstance().getGoals().isEmpty()){
      contentText.setText(Game.getInstance().getPlayer().getName()+" have reached the end of the game!");
      ...
      contentVBoxText.getChildren().add(contentText);
        for(Goal goal : Game.getInstance().getGoals()){
          if(goal instanceof ScoreGoal) {
            Text scoreGoalText = new Text("Score: " + Game.getInstance().getPlayer().getScore() + "/" + ((ScoreGoal) goal).getScoreGoal());
            if (goal.isFulfilled(Game.getInstance().getPlayer())){scoreGoalText.setFill(Color.GREEN);}
            else{scoreGoalText.setFill(Color.RED);}
          ...
          if(goal instanceof GoldGoal) {
            Text goldGoalText = new Text("Gold: " + Game.getInstance().getPlayer().getGold() + "/" + ((GoldGoal) goal).getGoldGoal());
            if (goal.isFulfilled(Game.getInstance().getPlayer())){goldGoalText.setFill(Color.GREEN);}
            else{goldGoalText.setFill(Color.RED);}
          ...
          if(goal instanceof HealthGoal) {
            Text healthGoalText = new Text("Health: " + Game.getInstance().getPlayer().getHealth() + "/" + ((HealthGoal) goal).getHealthGoal());
            if (goal.isFulfilled(Game.getInstance().getPlayer())){healthGoalText.setFill(Color.GREEN);}
            else{healthGoalText.setFill(Color.RED);}
    ...
    pathsWindowCenterBoxVBox.getChildren().clear();
    pathsWindowCenterBoxVBox.getChildren().addAll(titleText, contentVBoxText, restartButton, exitButton);
  }
